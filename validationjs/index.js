...
//print values in console to see if we are getting it or not
// console.log(username + email);


    //check username and verify username condition 
...
function checkpassword(password) {
    if (password.length > 6) {
        ...
        document.getElementById('password_error').innerText = 'Your password must be 6 digits long'
    }
}
